...
**Repository role:** Planned operator and team access can reference this configuration; telemetry collection does not acquire user authority from a provider choice.
